...
<div id="contenedor">
    ...
    <section><!-- InstanceBeginEditable name="EditRegion1" -->
     <p class="titulo">Listado de Noticias</p>
    ...
    <tr class="titulo_tabla">
        ...
        <td width="119" class="estilo8">Titulo</td>
        <td width="119" class="estilo8">Sumilla</td>
        <td width="131" class="estilo8">Autor</td>
        <td width="106" class="estilo8">Fecha</td>
        <td width="134" class="estilo8">Estado</td>  
        <td></td>      
    </tr>
   ...
   <?php
   	...
   	<tr>
   		<td class="estilo7"><?php echo $campo["codnoticias"]; ?></td>
        <td class="estilo7"><?php echo $campo["titulo"]; ?></td>
        <td class="estilo7"><?php echo $campo["sumilla"]; ?></td>
        <td class="estilo7"><?php echo $campo['author']; ?></td>
        <td class="estilo7"><?php echo $campo["fecha_ing"]; ?></td>
        <td class="estilo7"><?php echo $campo["estado"]; ?></td>
        <td class="estilo7">
            <a href="modificar_noticia.php?cod=<?php echo $campo['codnoticias']?>">Modificar</a> 
            <a href="eliminar_noticia.php?cod=<?php echo $campo['codnoticias']?>">Eliminar</a>
        </td>
   	</tr>
