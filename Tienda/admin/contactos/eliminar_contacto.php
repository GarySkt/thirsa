...
<div id="contenedor">
    ...
    <section><!-- InstanceBeginEditable name="EditRegion1" -->
     <p class="titulo">Eliminar contacto</p>
    ...
    <?php
		...
		$sql= "SELECT * FROM contactenos where codcontacto ='$codigo'";
		...
		echo "<a href='eliminar.php?cod=$codigo'>Si</a>   <a href='listar_contactos.php'>No</a>";		
	?>
	<!-- InstanceEndEditable -->
