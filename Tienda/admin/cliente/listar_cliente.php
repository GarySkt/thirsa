...
<div id="contenedor">
    ...
    <tr class="titulo_tabla">
        ...
        <td width="131" class="estilo8">Telefono</td>
        <td width="106" class="estilo8">Email</td>
   ...
   <?php
   	...
   	<tr>
   		<td class="estilo7"><?php echo $campo["codcliente"]; ?></td>
        <td class="estilo7"><?php echo $campo["nombres"]; ?></td>
        <td class="estilo7"><?php echo $campo["apellidos"]; ?></td>
       <td class="estilo7"><?php echo $campo["telefono"]; ?></td>
        <td class="estilo7"><?php echo $campo["email"]; ?></td>
        <td width="91" class="estilo7"><?php echo $campo["estado"]; ?></td>
        <td width="150" class="estilo7">
            <a href="modificar_cliente.php?cod=<?php echo $campo['codcliente']?>">Modificar</a> 
            <a href="eliminar_cliente.php?cod=<?php echo $campo['codcliente']?>">Eliminar</a>
        </td>
   	</tr>
