...
<div id="contenedor">
	...
	$sql= "SELECT * FROM categorias where codcategoria ='$codigo'";
    ...
    <p class="titulo">modificar nueva categoria</p>
        
    <form action="modificar.php" id="form1" name="form1" method="post">
    	<table>
          <tr>
              <td><input type="hidden" name="codigo" value="<?php echo $campo['codcategoria']; ?>"/></td>
          </tr>
          
          <tr>
              <td>Categoria:</td>
              <td><input type="text" name="categoria" value="<?php echo $campo['nom_categoria']; ?>" maxlength="20" pattern="^[a-zA-Z]*$" required/></td>
          </tr>
