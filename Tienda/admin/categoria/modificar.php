...
<div id="contenedor">
	...
	//nos conectamso a la BD y actualizamos el registro
  	$link = conectarse();
  	$sql="UPDATE categorias SET nom_categoria='$categoria' WHERE codcategoria='$codigo'";
  	$rs = mysql_query($sql);
  
  	if($rs==1)
 	{
		echo "<p class='titulo'>modificar nueva categoria</p>";
		echo "<center>El registro fue actualizado con exito</center>";
		echo "<br>";
		echo "<center><a href=\"listar_categoria.php\">Retornar</a></center>";
	}
	else
	{
		echo "<p class='titulo'>modificar nueva categoria</p>";
		...
		echo "<br>";
		echo "<center><a href=\"modificar_categoria.php\">Retornar</a></center>";
	}
	?>
	<!-- InstanceEndEditable -->
