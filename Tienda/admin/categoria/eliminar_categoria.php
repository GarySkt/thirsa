...
<div id="contenedor">
    ...
    <?php
		...
		echo "<center>¿Estas seguro que desea eliminar este registro?</center>";
		echo "<center><a href='eliminar.php?cod=$codigo'>Si</a>   <a href='listar_categoria.php'>No</a></center>";		
	?>
