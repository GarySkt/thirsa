...
<div id="contenedor">
  ...
  <div id="banner">
	...
	$sql="INSERT INTO clientes (nombres, apellidos, razonsocial, dni, direccion, telefono, email, clave, ocupacion, edad, fecha_nacim, estado) VALUES ('$nombres','$apellidos', '$razonsocial', '$dni', '$direccion', '$telefono', '$email', '$clave', '$ocupacion', '$edad', '$fechanac', 'Activo')";
  	$result = mysql_query($sql) or die("Fallo la consulta");
	
  	if($result)
 	{
		echo "<p>Felicidades</p>";
		echo "<p>Ud ha sido registrado en el sistema</p>";
	}
	else
	{
		echo "<p>Lo sentimos</p>";
		echo "<p>Hubo un error al momento de registrar sus datos. Por favor intentelo mas tarde</p>";
	}
