...
<div id="contenedor">
  ...
  <div id="banner">
    ...
    <table width="500" align="center">
    	<?php
		$query = mysql_query("SELECT * FROM productos ORDER BY fecha_ing  LIMIT 8");
		$contador=0;
		echo "<tr>";
			while($campo = MySQL_fetch_array($query))
			{
			...
			?>
                ...
                <td>
                    ...
                    <li>Precio Normal</li>
                    <li class= "precio">S/. <?php echo $campo['precio_normal']?></li>
                    <li>Precio Oferta</li>
                    <li class= "precio">S/. <?php echo $campo['precio_oferta']?></li>
                    <li class="detalle"><a href="detalle_producto.php?id=<? echo $campo['codproducto']?>">Ver detalles</a></li>
                    </ul>
                </td>
                <?php $contador++ ?>
            <?php
